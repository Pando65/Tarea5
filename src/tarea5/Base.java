...
public class Base {
     ...
     */
    public boolean intersecta(Object objPersonaje) {
        //valido si el objeto es de tipo Base
        if(objPersonaje instanceof Base) {
            
            //Creo los rectangulos de ambos objetos
            Rectangle rctEste = new Rectangle(this.getX(), this.getY(), 
                    this.getAncho(), this.getAlto());
            Base basTemp = (Base) objPersonaje;
            Rectangle rctOtro = new Rectangle(basTemp.getX(), 
                    basTemp.getY(), basTemp.getAncho(), 
                    basTemp.getAlto());
